...
- `Main.vi` 和 `.lvproj` 是核心工程文件，建议保留。
- `.doc` 实验指导书可作为课程实验说明一并上传。
- `视频3.mp4` 和 `视频4.mp4` 文件较大，如果仓库体积需要控制，建议使用 Git LFS 管理视频文件，或将视频上传到 Release / 网盘后在 README 中放链接。
- 若项目要公开发布，请确认实验指导书和视频素材允许公开分享。
